    ...
    >
      ...
      <div ref={textRef} className="flex-1 w-full max-w-lg">
        ...
        <p className="text-white/55 text-sm leading-[2]">
          言い訳をしない、ということではありません。意図がどうであれ、自分の行動が生む結果を、自分のものとして引き受けるということです。「意図していなかった」は免罪符にはならない。自分の行動が生んだものはすべて自分のもの、そう受け止めることが、判断の質を上げると思っています。だからこそ、何かを決断するとき、その先に何が起きうるかを常に考えるようになりました。それが今の自分の行動規範になっています。
        </p>
      </div>
    </div>
  )
  ...
  return (
    ...
    >
      ...
      <div ref={textRef} className="flex-1 w-full max-w-lg">
        ...
        <p className="text-white/55 text-sm leading-[2] whitespace-pre-line">
          {'ずっと自分が一番だと思っていた主人公が、同級生の圧倒的な画力を目の当たりにした瞬間のセリフ。絶望ではなく、悔しさに火がついた瞬間です。\n\n自分より遥かに上の存在に出会った時、萎縮するのではなくこう思えるかどうか。知見の深い人と話した時に悔しさを感じるのは、自分がまだ本気で追いかけているからだと思うようにしました。悔しいと感じられる間は、まだ諦めていない証拠です。その感情を、立ち止まる理由ではなく前に進む燃料にしたいと思っています。'}
        </p>
      </div>
    </div>
  )
